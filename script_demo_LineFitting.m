%% Introduction to and Purpose of the LineFitting Code
% This is a demonstration script to show how to perform linear fitting of a
% set of points
%
% This is the explanation of the code that can be found by running
%       script_demo_LineFitting.m
%
% This is a script to demonstrate the functions within SlopeInterceptFromNPoints
% library. This code repo is typically located at:
%
%   https://github.com/ivsg-psu/FeatureExtraction_Association_LineFitting
%
...
%% Revision History:
% 2023_07_18 - sbrennan@psu.edu 
% -- First write of code using LoadWZ main script as starter 
...
if ~exist('flag_LineFitting_Folders_Initialized','var')
    this_project_folders = {'Functions','Data'};
    fcn_INTERNAL_initializeUtilities(library_name,library_folders,library_url,this_project_folders);  
    flag_LineFitting_Folders_Initialized = 1;
end
